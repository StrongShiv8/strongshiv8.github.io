...
I loaded port 80 and I got this `siteisup.htb` domain name display on webpage so I set the /etc/hosts file then I checked the input file seams like SSRF vulnerability but moving on to that direction I also checked for directory traversal and got `.git` directory.
