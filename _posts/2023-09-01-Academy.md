...
Site redirected to [http:/academy.htb](http:/academy.htb) so lets set the /etc/hosts file as academy.htb now →
...
Now I ran [linpeas.sh](http:/linpeas.sh) file because I didnt find anything and I got something from it also →
